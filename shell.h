 ...
 *@env: linked list local copys of environment
 *@environ: custom modified copy of environm from LL env
 *@history: the histo node
 *@alias: the alias node
 *@env_changed: on if environ was changed
 *@status: Return status of the last exec'd command
 *@cmd_buf: the address of pointer to cmd_buf, on if chaining
 *@cmd_buf_type: CMD_type ||, &&, ;
 *@readfd: the fd from which to read line input to
 *@histcount: the histo line number count
 */
...
/**
 *struct builtin - this contain a builtin stri and related function
