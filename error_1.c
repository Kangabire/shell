...
/**
 * _erratoi - converts a str to an intege
 * @s: the str to be converted
 * Return: 0 if no numbers in str is a converted number else
 *       -1 on error
 */
int _erratoi(char *s)
{
 ...
 * @estr: str containing the specified error type
...
/**
 * convert_number - converter function, an exact clone of itoa
 * @num: number
 * @base: base
